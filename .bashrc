...
xinput --set-prop 11 293 1 # enable natural scrolling (invert scroll direction)
xinput --set-prop 11 300 0.8 # increase mouse speed (accelerate)

# 12 is device id of "TPPS/2 IBM TrackPoint"
xinput --set-prop 12 300 -0.4 # slow down the trackpoint speed
